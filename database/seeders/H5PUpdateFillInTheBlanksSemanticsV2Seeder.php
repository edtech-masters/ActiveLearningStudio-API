...
class H5PUpdateFillInTheBlanksSemanticsV2Seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $h5pFibLibParams = ['name' => "H5P.Blanks", "major_version" => 1, "minor_version" => 14];
        $h5pFibLib = DB::table('h5p_libraries')->where($h5pFibLibParams)->pluck('id');
        if ($h5pFibLib) {
            DB::table('h5p_libraries')->where($h5pFibLibParams)->update([
