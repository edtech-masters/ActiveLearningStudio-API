...
class H5PUpdateDragDropSemanticsV3Seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $h5pDragQuestionLib = DB::table('h5p_libraries')->where($h5pDragQuestionLibParams)->pluck('id');
  ...
  },
  {
    ...
    "fields": [
      ...
      {
        "name": "ignoreInSummarySlide",
        "label": "Ignore in Summary Slide",
        "type": "boolean",
        "importance": "low",
        "description": "If checked, learners will not able see the this slide & score in summary slide of complex activities.",
        "default": false,
        "optional": true
      }
    ]
