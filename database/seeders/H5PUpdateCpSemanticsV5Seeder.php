...
class H5PUpdateCpSemanticsV5Seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $h5pCPParams = ['name' => "H5P.CoursePresentation", "major_version" => 1, "minor_version" => 24];
        $h5pCPLib = DB::table('h5p_libraries')->where($h5pCPParams)->pluck('id');
        if ($h5pCPLib) {
            DB::table('h5p_libraries')->where($h5pCPParams)->update([
  ...
  },
  {
    ...
    "fields": [
      ...
      {
        "name": "enableEmbedOption",
        "type": "boolean",
        "label": "Enable embed icon",
        "importance": "low",
        "default": false
      },
      {
        "name": "enableExportOption",
        "type": "boolean",
        "label": "Enable Export icon",
        "importance": "low",
        "default": false
      },
      {
      ...
      },
      {
        "name": "autoGrading",
        "type": "group",
        "label": "Auto Grading Activities",
        "importance": "low",
        "description": "These options will let you override the summary page for hiding score and show as auto grading.",
        "optional": true,
        "fields": [
          {
            "name": "H5P.Blanks",
          ...
          {
            "name": "H5P.ImageMultipleHotspotQuestion",
            "type": "boolean",
            "label": "Image Multiple Hotspot Question",
            "importance": "low",
            "default": false
          },
          {
