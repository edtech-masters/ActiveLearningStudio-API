...
class H5PUpdateFindMultipleHotspotsSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $h5pEditorImageMultipleHotspotQuestionLibParams = ['name' => "H5PEditor.ImageMultipleHotspotQuestion", "major_version" => 1, "minor_version" => 0];
        $h5pEditorImageMultipleHotspotQuestionLib = DB::table('h5p_libraries')->where($h5pEditorImageMultipleHotspotQuestionLibParams)->first();
        $h5pEditorImageMultipleHotspotQuestionLibId = $h5pEditorImageMultipleHotspotQuestionLib->id;

        // old library
        $h5pDragNBarOldLibParams = ['name' => "H5P.DragNBar", "major_version" => 1, "minor_version" => 4];
        $h5pDragNBarOldLib = DB::table('h5p_libraries')->where($h5pDragNBarOldLibParams)->first();
        $h5pDragNBarOldLibId = $h5pDragNBarOldLib->id;


        // new library to be updated
        $h5pDragNBarNewLibParams = ['name' => "H5P.DragNBar", "major_version" => 1, "minor_version" => 5];
        $h5pDragNBarNewLib = DB::table('h5p_libraries')->where($h5pDragNBarNewLibParams)->first();
        $h5pDragNBarNewLibId = $h5pDragNBarNewLib->id;

        $h5pLibrariesLibrariesParams = [
            'library_id' => $h5pEditorImageMultipleHotspotQuestionLibId,
            'required_library_id' => $h5pDragNBarOldLibId,
            'dependency_type' => 'preloaded'
        ];
        DB::table('h5p_libraries_libraries')->where($h5pLibrariesLibrariesParams)->update(
            [
                'required_library_id' => $h5pDragNBarNewLibId,
            ]
         );
    }
