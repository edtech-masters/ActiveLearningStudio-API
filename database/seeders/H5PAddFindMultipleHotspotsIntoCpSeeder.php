...
class H5PAddFindMultipleHotspotsIntoCpSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $h5pCPLibParams = ['name' => "H5P.CoursePresentation", "major_version" => 1, "minor_version" => 24];
        $h5pCPLib = DB::table('h5p_libraries')->where($h5pCPLibParams)->first();
        if ($h5pCPLib) {
            DB::table('h5p_libraries')->where($h5pCPLibParams)->update([
        ...
        $h5pImageMultipleHotspotQuestionLibParams = ['name' => "H5P.ImageMultipleHotspotQuestion", "major_version" => 1, "minor_version" => 0];
        $h5pImageMultipleHotspotQuestionLib = DB::table('h5p_libraries')->where($h5pImageMultipleHotspotQuestionLibParams)->first();
        $h5pImageMultipleHotspotQuestionLibId = $h5pImageMultipleHotspotQuestionLib->id;

        DB::table('h5p_libraries_libraries')->insert([
            [
                'library_id' => $h5pEditorCoursePresentationParamsLibId,
                'required_library_id' => $h5pImageMultipleHotspotQuestionLibId,
